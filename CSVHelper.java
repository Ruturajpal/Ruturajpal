...
public class CSVHelper {
  ...
  public static List<DeveloperTutorial> csvToTutorials(InputStream is) {
    try (BufferedReader fileReader = new BufferedReader(new InputStreamReader(is, "UTF-8"));
        CSVParser csvParser = new ClassParser(fileReader,
  ...
  public static <CSVFormat> ByteArrayInputStream tutorialsToCSV(List<DeveloperTutorial> developerTutorialList) {
